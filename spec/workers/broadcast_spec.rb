...
RSpec.describe Products::Broadcast, type: :worker do
  include AppHelper

  let(:scheduled_job) { Products::Broadcast.perform_async(product.id, true) }
  describe 'testing worker' do
    it 'Products::Broadcast jobs are enqueued in the default queue' do
